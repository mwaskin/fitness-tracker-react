			...
			{myRoutines.map((routine) => {
				return (
					<div key={routine.id} className="my-routine">
						...
						<p className="my-routine-creator">
						...
						{routine.activities.map((activity) => {
							return (
								<div key={activity.id} className="my-routine-activity">
									...
									<p className="my-routine-activity-description">
										Description: {activity.description}
									</p>
									<p className="my-routine-activity-duration">
										Duration: {activity.duration}
									</p>
									<p className="my-routine-activity-count">
